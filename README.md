...
Tech Stack
AreaTools / TechnologiesProgrammingPythonML LibrariesTensorFlow, Keras, Scikit-learn, XGBoostData HandlingPandas, NumPyVisualizationMatplotlib, Seaborn, PlotlyImage ProcessingOpenCVDeploymentFastAPIGUITkinterForecastingFacebook Prophet, ARIMADatasetSynthetic + Realistic (CSV and Image)
Dataset Overview
...
2. weather_socioeconomic_data.csv

Temperature, rainfall, and humidity mapped to date
Unemployment rate and population density
Critical for understanding environmental and socio-economic impact on crime

3. event_holiday_data.csv
...
4. surveillance_crime_images.zip
...
Synthetic but visually representative of real surveillance scenarios
...
git clone https://github.com/mskumar1210/Crime-Rate-Prediction.git
...
Usage
Training the Models
bash# Train LSTM forecasting model
...
python gui_app.py
Making Predictions
python# Example: Forecast next 30 days
